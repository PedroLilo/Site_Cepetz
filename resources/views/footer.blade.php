<footer class="cepetz-footer">
    <div class="cepetz-footer-top">
        ...
        <div class="footer-center">
            <h4 class="titleFooter">Contatos</h4>
            <ul>
                <a href="https://www.instagram.com/cepetzvarginha/">
                    <li>@cepetzvarginha</li>
                </a>
                <a href="https://www.instagram.com/sitiomariajose/">
                    <li>@sitiomariajose</li>
                </a>
                <a href="https://www.instagram.com/cepet.z/">
                    <li>@cepet.z</li>
                </a>
